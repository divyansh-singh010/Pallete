...
<div className="social-icons">
    ...
    <div className="icon-container">
        <a href="https://www.instagram.com/palateculinary/?hl=en" className='icon' target="_blank" rel="noopener noreferrer">
        ...
        <a href="https://m.facebook.com/comediscoverjoyofcooking/" className='icon' target="_blank" rel="noopener noreferrer">
        ...
        <a href="https://www.youtube.com/@chefrakheevaswani" className='icon' target="_blank" rel="noopener noreferrer">
